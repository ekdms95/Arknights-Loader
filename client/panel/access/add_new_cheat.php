						...
						<div class="card">
							...
							<div class="card-body p-6">
							    <form name="input" action="" method="post">
							        <center><div class="card-title">Add new cheat</div></center>
									<div class="spacing"></div>
									<center><div class='text-muted'> Name <br/></div></center>
									...
									<div class="form-footer">
										<button type="submit" name="sub" class="btn btn-danger btn-block">Add</button>
									</div>
									<div class="spacing"></div>
    						        <?php 
                                        if (isset($_POST["name"]) && isset($_POST["secure"])) 
                                        {
                                            $add_new_cheat = $panel_admin::add_new_cheat($_POST["name"], $_POST["secure"]);
                                            
                                            if (!$add_new_cheat)
                                               echo "<center><div class='text-muted'> Cheat already exist <br/></div></center>";
                                            else 
